const ARTICLES = [
    ...
    },
    {
        ...
        content: `
            ...
            <p>Glagolitic, while phonetically perfect, was difficult to write and even harder to teach to a population already somewhat familiar with Greek letters from trade and limited education. So the brothers' students developed a new, simpler alphabet, most likely at the Preslav Literary School around the 890s. It was based heavily on Greek uncial script (a form of rounded capital letters used in manuscripts of the era). Unlike the complex, unique letterforms of Glagolitic, this new script borrowed directly from the Greek letters that educated Bulgarians already recognized, supplementing them with letters taken from Glagolitic for sounds that didn't exist in Greek. No contemporary source names a single inventor.</p>
            <p>The result was easier to teach, easier to write, easier to carve into stone or wood, and more visually compatible with the existing Greek texts that circulated in Bulgaria. Clement, for his part, developed a system of teaching literacy that proved remarkably effective. He reportedly trained 3,500 students in his career, according to medieval hagiographies.</p>
            <p>The new alphabet was named "Cyrillic" (Kirilitsa in Slavic) in honor of Saint Cyril, a tribute to the mission that made it possible, not a claim that he designed it. An older tradition, still repeated in many popular histories, goes further and credits Clement of Ohrid with creating the letters. But the school at Ohrid went on using Glagolitic for centuries, which is why most scholars now point to Preslav instead. The naming has caused centuries of historical confusion, but the tribute was appropriate. Without Cyril's foundational work and his insistence on Slavic-language literacy, neither Glagolitic nor Cyrillic would exist.</p>

...
const ARTICLE_META = {
    ...
    'first-25-words':           { section: 'Getting Started',           published: '2026-02-20', modified: '2026-09-16', keywords: ['russian words', 'reading practice', 'first words', 'beginner russian'] },
    ...
    'cyrillic-letters-not-in-russian': { section: 'Alphabet Variants',         published: '2026-06-21', modified: '2026-09-16', keywords: ['cyrillic letters not in russian', 'non-russian cyrillic', 'ukrainian serbian macedonian letters', 'cyrillic alphabet differences'] },
    'serbian-cyrillic-vs-latin':{ section: 'Alphabet Variants',         published: '2026-02-24', modified: '2026-09-16', keywords: ['serbian cyrillic', 'serbian latin', 'digraphia', 'dual script'] },
    // History & Culture
    'lost-letters':             { section: 'History & Culture',         published: '2026-02-16', modified: '2026-09-16', keywords: ['lost letters', 'extinct characters', 'cyrillic history', 'old church slavonic'] },
    ...
    'backwards-r-myth':         { section: 'History & Culture',         published: '2026-02-26', modified: '2026-09-16', keywords: ['backwards R', 'reverse R', 'Cyrillic Я letter', 'faux Cyrillic'] },
    ...
    'cyrillic-pop-culture':     { section: 'History & Culture',         published: '2026-03-06', modified: '2026-09-16', keywords: ['cyrillic movies', 'pop culture', 'rocky iv', 'call of duty', 'faux cyrillic'] },
    ...
    'letter-yo-story':          { section: 'History & Culture',         published: '2026-04-15', modified: '2026-09-16', keywords: ['letter yo russian', 'russian letter ё', 'karamzin letter yo', 'princess dashkova', 'russian spelling', 'yofikator', 'optional russian letter', 'cyrillic letter ё history'] },

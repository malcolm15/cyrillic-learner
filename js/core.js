...
const ARTICLE_META = {
    // Getting Started
    'getting-started':          { section: 'Getting Started',           published: '2026-02-10', modified: '2026-09-18', keywords: ['cyrillic alphabet', 'learn cyrillic', 'beginner guide', 'russian letters'] },
    ...
    'serbian-cyrillic-vs-latin':{ section: 'Alphabet Variants',         published: '2026-02-24', modified: '2026-09-17', keywords: ['serbian cyrillic', 'serbian latin', 'digraphia', 'dual script'] },
    // History & Culture
    'lost-letters':             { section: 'History & Culture',         published: '2026-02-16', modified: '2026-09-17', keywords: ['lost letters', 'extinct characters', 'cyrillic history', 'old church slavonic'] },
    ...
    'cyrillic-names-europe':    { section: 'History & Culture',         published: '2026-02-18', modified: '2026-09-17', keywords: ['cyrillic names', 'european languages', 'alphabet names', 'azbuka'] },
    'backwards-r-myth':         { section: 'History & Culture',         published: '2026-02-26', modified: '2026-09-17', keywords: ['backwards R', 'reverse R', 'Cyrillic Я letter', 'faux Cyrillic'] },
    ...
    'history-of-cyrillic':      { section: 'History & Culture',         published: '2026-03-02', modified: '2026-09-18', keywords: ['cyrillic history', 'saints to superpower', 'slavic alphabet', 'writing history'] },
    ...
    'cyrillic-pop-culture':     { section: 'History & Culture',         published: '2026-03-06', modified: '2026-09-17', keywords: ['cyrillic movies', 'pop culture', 'rocky iv', 'call of duty', 'faux cyrillic'] },
    'cyrillic-vs-greek':        { section: 'History & Culture',         published: '2026-05-15', modified: '2026-09-15', keywords: ['cyrillic vs greek alphabet', 'greek and cyrillic comparison', 'cyrillic greek similarities', 'cyrillic greek differences', 'cyrillic origin greek'] },
    'letter-yo-story':          { section: 'History & Culture',         published: '2026-04-15', modified: '2026-09-17', keywords: ['letter yo russian', 'russian letter ё', 'karamzin letter yo', 'princess dashkova', 'russian spelling', 'yofikator', 'optional russian letter', 'cyrillic letter ё history'] },
    // Learning Tools & Resources
    'cyrillic-copy-paste':      { section: 'Learning Tools & Resources', published: '2026-03-01', modified: '2026-09-16', keywords: ['cyrillic copy paste', 'russian letters clipboard', 'cyrillic characters', 'accented cyrillic vowels', 'russian stress marks', 'pre-reform russian letters', 'yat letter', 'copy tool'] },
    ...
    'russian-alphabet-chart':   { section: 'Learning Tools & Resources', published: '2026-02-12', modified: '2026-09-18', keywords: ['russian alphabet chart', '33 letters', 'pronunciation guide', 'interactive chart', 'printable russian alphabet chart', 'russian alphabet chart pdf'] },
